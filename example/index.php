...
<body>
  <article>
    ...
    <h2>Locator Examples</h2>
      <p>Single page locator:</p>
      <p>Here is a citation pointing to page 45:
        <?php echo $citeProc->render($data, "citation", json_decode('[{"id":"ITEM-1", "locator":"45"}]')); ?></p>
      <p>Page range locator:</p>
      <p>Citation with a page range (120-125):
        <?php echo $citeProc->render($data, "citation", json_decode('[{"id":"ITEM-1", "locator":"120-125"}]')); ?></p>
      <p>Chapter locator:</p>
      <p>Citation with a chapter locator:
        <?php echo $citeProc->render($data, "citation", json_decode('[{"id":"ITEM-1", "locator":"chapter 3"}]')); ?></p>
      <p>Multiple citations (one with locator, one without:</P
      <p>Two citations in one reference: ITEM-3 (page 160) and ITEM-4 (no locator):
        <?php echo $citeProc->render($data, "citation", json_decode('[{"id":"ITEM-3", "locator":"160"}, {"id":"ITEM-4"}]')); ?></p>
