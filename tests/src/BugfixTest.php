...
class BugfixTest extends TestCase
{
    ...
    public function testBugfixGithub105()
    {
        $this->runTestSuite("bugfix-github-105");
    }

    public function testBugfixGithub106()
    {
        $this->runTestSuite('bugfix-github-106');
    }

    public function testBugfixGithub116()
    {
        $this->runTestSuite('bugfix-github-116');
    }

    public function testBugfixGithub117()
    {
    ...
    public function testBugfixGithub145()
    {
        $this->runTestSuite('bugfix-github-145');
    }

    public function testBugfixGithub184()
    {
        $this->runTestSuite('bugfix-github-184');
    }
}
